...
class LoginFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        loginViewModel.navigatetoRegister.observe(requireActivity(), Observer { hasFinished->
            if (hasFinished == true){
        ...
        loginViewModel.errotoast.observe(requireActivity(), Observer { hasError->
            if(hasError==true){
        ...
        loginViewModel.errotoastUsername .observe(requireActivity(), Observer { hasError->
            if(hasError==true){
        ...
        loginViewModel.errorToastInvalidPassword.observe(requireActivity(), Observer { hasError->
            if(hasError==true){
        ...
        loginViewModel.navigatetoUserDetails.observe(requireActivity(), Observer { hasFinished->
            if (hasFinished == true){
                Log.i("MYTAG","insidi observe")
                navigateUserDetails()
